...
// finally change the color
        ...
        donation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(null!=activenetwork){
                    startActivity(new Intent(slideactivity.this, com.example.porte_chai.donation.class));
                }
                else
                {
        ...
        receiption.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NetworkInfo activenetwork = manager.getActiveNetworkInfo();
                if(null!=activenetwork){
                    startActivity(new Intent(slideactivity.this, com.example.porte_chai.receiption.class));
                }
                else
                {
                    Toast.makeText(slideactivity.this,"No Internet Connection",Toast.LENGTH_SHORT).show();
        ...
        aboutus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(slideactivity.this, com.example.porte_chai.aboutus.class));
            }
        });
